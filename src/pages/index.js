        ...
        <Grid item xs={12} lg={6} className="homeIntro">
          ...
          <animated.div style={animatedTexts[1]}>
            <Typography variant="body1">
              ...
              A motivated and enthusiastic Python developer with a solid foundation in computer science principles and programming fundamentals.
              </Translate>{" "}
            </Typography>
          </animated.div>
          &nbsp;
          <animated.div style={animatedTexts[2]}>
            ...
            <Typography variant="body1" gutterBottom>
              Python, Code optimization and performance tuning, Team collaboration and communication
            </Typography>
          </animated.div>
          &nbsp;
  ...
  return (
    <animated.div className="social__links" style={animatedProps}>
      <Grid container spacing={2}>
        ...
        <Grid item>
          <a href="https://github.com/Arvind-2929">
